...
node scripts/generate-mock-data.js --count 10 --type successful
...
echo "3. Generate more mock data: npm run generate:mixed"
echo "4. Run the advanced simulator: npm run simulator:generated"
echo "5. View the dashboard: open dashboard/index.html"
echo "6. Run evaluations: npm run evaluate"
echo ""
...
echo ""
echo "Mock Data Generation (Required for simulator:generated):"
...
echo ""
echo "Note: The advanced simulator (npm run simulator:generated) requires mock data files."
echo "      Initial mock data has been generated during setup."
echo ""
